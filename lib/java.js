...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c203 = /^[ a-zA-Z0-9]/,
      peg$c204 = peg$classExpectation([" ", ["a", "z"], ["A", "Z"], ["0", "9"]], false, false),
      peg$c205 = function(first, rest) { return { identifier: first + rest, node: 'SimpleName' }; },
      peg$c206 = /^[a-z]/,
      peg$c207 = peg$classExpectation([["a", "z"]], false, false),
      peg$c208 = /^[A-Z]/,
      peg$c209 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c210 = /^[_$]/,
      peg$c211 = peg$classExpectation(["_", "$"], false, false),
      peg$c212 = /^[0-9]/,
      peg$c213 = peg$classExpectation([["0", "9"]], false, false),
      peg$c214 = "assert",
      peg$c215 = peg$literalExpectation("assert", false),
      peg$c216 = "break",
      peg$c217 = peg$literalExpectation("break", false),
      peg$c218 = "case",
      peg$c219 = peg$literalExpectation("case", false),
      peg$c220 = "catch",
      peg$c221 = peg$literalExpectation("catch", false),
      peg$c222 = "class",
      peg$c223 = peg$literalExpectation("class", false),
      peg$c224 = "const",
      peg$c225 = peg$literalExpectation("const", false),
      peg$c226 = "continue",
      peg$c227 = peg$literalExpectation("continue", false),
      peg$c228 = "default",
      peg$c229 = peg$literalExpectation("default", false),
      peg$c230 = "do",
      peg$c231 = peg$literalExpectation("do", false),
      peg$c232 = "else",
      peg$c233 = peg$literalExpectation("else", false),
      peg$c234 = "enum",
      peg$c235 = peg$literalExpectation("enum", false),
      peg$c236 = "extends",
      peg$c237 = peg$literalExpectation("extends", false),
      peg$c238 = "false",
      peg$c239 = peg$literalExpectation("false", false),
      peg$c240 = "finally",
      peg$c241 = peg$literalExpectation("finally", false),
      peg$c242 = "for",
      peg$c243 = peg$literalExpectation("for", false),
      peg$c244 = "goto",
      peg$c245 = peg$literalExpectation("goto", false),
      peg$c246 = "if",
      peg$c247 = peg$literalExpectation("if", false),
      peg$c248 = "implements",
      peg$c249 = peg$literalExpectation("implements", false),
      peg$c250 = "import",
      peg$c251 = peg$literalExpectation("import", false),
      peg$c252 = "interface",
      peg$c253 = peg$literalExpectation("interface", false),
      peg$c254 = "instanceof",
      peg$c255 = peg$literalExpectation("instanceof", false),
      peg$c256 = "new",
      peg$c257 = peg$literalExpectation("new", false),
      peg$c258 = "null",
      peg$c259 = peg$literalExpectation("null", false),
      peg$c260 = "package",
      peg$c261 = peg$literalExpectation("package", false),
      peg$c262 = "return",
      peg$c263 = peg$literalExpectation("return", false),
      peg$c264 = "super",
      peg$c265 = peg$literalExpectation("super", false),
      peg$c266 = "switch",
      peg$c267 = peg$literalExpectation("switch", false),
      peg$c268 = "this",
      peg$c269 = peg$literalExpectation("this", false),
      peg$c270 = "throws",
      peg$c271 = peg$literalExpectation("throws", false),
      peg$c272 = "throw",
      peg$c273 = peg$literalExpectation("throw", false),
      peg$c274 = "true",
      peg$c275 = peg$literalExpectation("true", false),
      peg$c276 = "try",
      peg$c277 = peg$literalExpectation("try", false),
      peg$c278 = "void",
      peg$c279 = peg$literalExpectation("void", false),
      peg$c280 = "while",
      peg$c281 = peg$literalExpectation("while", false),
      peg$c282 = function() { return { node: 'BooleanLiteral', booleanValue: true }; },
      peg$c283 = function() { return { node: 'BooleanLiteral', booleanValue: false }; },
      peg$c284 = function() { return { node: 'NullLiteral' }; },
      peg$c285 = function(literal) { return literal; },
      peg$c286 = /^[lL]/,
      peg$c287 = peg$classExpectation(["l", "L"], false, false),
      peg$c288 = function() { return { node: 'NumberLiteral', token: text() }; },
      peg$c289 = "0",
      peg$c290 = peg$literalExpectation("0", false),
      peg$c291 = /^[1-9]/,
      peg$c292 = peg$classExpectation([["1", "9"]], false, false),
      peg$c293 = /^[_]/,
      peg$c294 = peg$classExpectation(["_"], false, false),
      peg$c295 = "0x",
      peg$c296 = peg$literalExpectation("0x", false),
      peg$c297 = "0X",
      peg$c298 = peg$literalExpectation("0X", false),
      peg$c299 = "0b",
      peg$c300 = peg$literalExpectation("0b", false),
      peg$c301 = "0B",
      peg$c302 = peg$literalExpectation("0B", false),
      peg$c303 = /^[01]/,
      peg$c304 = peg$classExpectation(["0", "1"], false, false),
      peg$c305 = /^[0-7]/,
      peg$c306 = peg$classExpectation([["0", "7"]], false, false),
      peg$c307 = ".",
      peg$c308 = peg$literalExpectation(".", false),
      peg$c309 = /^[fFdD]/,
      peg$c310 = peg$classExpectation(["f", "F", "d", "D"], false, false),
      peg$c311 = /^[eE]/,
      peg$c312 = peg$classExpectation(["e", "E"], false, false),
      peg$c313 = /^[+\-]/,
      peg$c314 = peg$classExpectation(["+", "-"], false, false),
      peg$c315 = /^[pP]/,
      peg$c316 = peg$classExpectation(["p", "P"], false, false),
      peg$c317 = /^[a-f]/,
      peg$c318 = peg$classExpectation([["a", "f"]], false, false),
      peg$c319 = /^[A-F]/,
      peg$c320 = peg$classExpectation([["A", "F"]], false, false),
      peg$c321 = "'",
      peg$c322 = peg$literalExpectation("'", false),
      peg$c323 = /^['\\\n\r]/,
      peg$c324 = peg$classExpectation(["'", "\\", "\n", "\r"], false, false),
      peg$c325 = function() { return { node: 'CharacterLiteral', escapedValue: text() }; },
      peg$c326 = "\"",
      peg$c327 = peg$literalExpectation("\"", false),
      peg$c328 = /^["\\\n\r]/,
      peg$c329 = peg$classExpectation(["\"", "\\", "\n", "\r"], false, false),
      peg$c330 = function() { return { node: 'StringLiteral', escapedValue: text() }; },
      peg$c331 = "\\",
      peg$c332 = peg$literalExpectation("\\", false),
      peg$c333 = /^[btnfr"'\\]/,
      peg$c334 = peg$classExpectation(["b", "t", "n", "f", "r", "\"", "'", "\\"], false, false),
      peg$c335 = /^[0-3]/,
      peg$c336 = peg$classExpectation([["0", "3"]], false, false),
      peg$c337 = "u",
      peg$c338 = peg$literalExpectation("u", false),
      peg$c339 = "@",
