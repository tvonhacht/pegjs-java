...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c153 = "public",
      peg$c154 = peg$literalExpectation("public", false),
      peg$c155 = "protected",
      peg$c156 = peg$literalExpectation("protected", false),
      peg$c157 = "private",
      peg$c158 = peg$literalExpectation("private", false),
      peg$c159 = "static",
      peg$c160 = peg$literalExpectation("static", false),
      peg$c161 = "abstract",
      peg$c162 = peg$literalExpectation("abstract", false),
      peg$c163 = "final",
      peg$c164 = peg$literalExpectation("final", false),
      peg$c165 = "native",
      peg$c166 = peg$literalExpectation("native", false),
      peg$c167 = "synchronized",
      peg$c168 = peg$literalExpectation("synchronized", false),
      peg$c169 = "transient",
      peg$c170 = peg$literalExpectation("transient", false),
      peg$c171 = "volatile",
      peg$c172 = peg$literalExpectation("volatile", false),
      peg$c173 = "strictfp",
      peg$c174 = peg$literalExpectation("strictfp", false),
      peg$c175 = function(keyword) { return makeModifier(keyword); },
      peg$c176 = function(id, body) { 
            return {
      ...
      peg$c177 = function(decl) { return skipNulls(decl); },
      peg$c178 = function(modifiers, rest) { return mergeProps(rest, { modifiers: modifiers }); },
      peg$c179 = function(type, rest) { return mergeProps(rest, { type: type }); },
      peg$c180 = function(id, def) { 
            return { 
      ...
      peg$c181 = function(fragments) { return { node: 'FieldDeclaration', fragments: fragments }; },
      peg$c182 = function(val) { return val; },
      peg$c183 = function(id, pairs) { 
            return { 
      ...
      peg$c185 = function(id) { return { node: 'MarkerAnnotation', typeName: id }; },
      ...
      peg$c187 = function(values) { return { node: 'ArrayInitializer', expressions: optionalList(values)}; },
      peg$c188 = /^[ \t]/,
      peg$c189 = peg$classExpectation([" ", "\t"], false, false),
      peg$c190 = /^[ \t\r\n\f]/,
      peg$c191 = peg$classExpectation([" ", "\t", "\r", "\n", "\f"], false, false),
      peg$c192 = function(commentStatements) { return leadingComments(commentStatements); },
      peg$c193 = function(comment) { return comment; },
      peg$c194 = function(commentStatement) { return commentStatement; },
      peg$c195 = "/**",
      peg$c196 = peg$literalExpectation("/**", false),
      peg$c197 = "*/",
      peg$c198 = peg$literalExpectation("*/", false),
      peg$c199 = function(comment) { return { value: "/**" + comment.join("") + "*/" }; },
      peg$c200 = "/*",
      ...
      peg$c207 = function(letter) { return letter[1]; },
      peg$c208 = "//",
      peg$c209 = peg$literalExpectation("//", false),
      peg$c210 = function(comment) { return { value: "//" + comment.join("") }; },
      peg$c211 = function(first, rest) { return { identifier: first + rest, node: 'SimpleName' }; },
      peg$c212 = /^[a-z]/,
      peg$c213 = peg$classExpectation([["a", "z"]], false, false),
      peg$c214 = /^[A-Z]/,
      peg$c215 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c216 = /^[_$]/,
      peg$c217 = peg$classExpectation(["_", "$"], false, false),
      peg$c218 = /^[0-9]/,
      peg$c219 = peg$classExpectation([["0", "9"]], false, false),
      peg$c220 = "assert",
      peg$c221 = peg$literalExpectation("assert", false),
      peg$c222 = "break",
      peg$c223 = peg$literalExpectation("break", false),
      peg$c224 = "case",
      peg$c225 = peg$literalExpectation("case", false),
      peg$c226 = "catch",
      peg$c227 = peg$literalExpectation("catch", false),
      peg$c228 = "class",
      peg$c229 = peg$literalExpectation("class", false),
      peg$c230 = "const",
      peg$c231 = peg$literalExpectation("const", false),
      peg$c232 = "continue",
      ...
      peg$c240 = "enum",
      peg$c241 = peg$literalExpectation("enum", false),
      peg$c242 = "extends",
      peg$c243 = peg$literalExpectation("extends", false),
      peg$c244 = "false",
      peg$c245 = peg$literalExpectation("false", false),
      peg$c246 = "finally",
      peg$c247 = peg$literalExpectation("finally", false),
      peg$c248 = "for",
      peg$c249 = peg$literalExpectation("for", false),
      peg$c250 = "goto",
      peg$c251 = peg$literalExpectation("goto", false),
      peg$c252 = "if",
      peg$c253 = peg$literalExpectation("if", false),
      peg$c254 = "implements",
      peg$c255 = peg$literalExpectation("implements", false),
      peg$c256 = "import",
      peg$c257 = peg$literalExpectation("import", false),
      peg$c258 = "interface",
      peg$c259 = peg$literalExpectation("interface", false),
      peg$c260 = "instanceof",
      peg$c261 = peg$literalExpectation("instanceof", false),
      peg$c262 = "new",
      peg$c263 = peg$literalExpectation("new", false),
      peg$c264 = "null",
      peg$c265 = peg$literalExpectation("null", false),
      peg$c266 = "package",
      peg$c267 = peg$literalExpectation("package", false),
      peg$c268 = "return",
      peg$c269 = peg$literalExpectation("return", false),
      peg$c270 = "super",
      peg$c271 = peg$literalExpectation("super", false),
      peg$c272 = "switch",
      peg$c273 = peg$literalExpectation("switch", false),
      peg$c274 = "this",
      peg$c275 = peg$literalExpectation("this", false),
      peg$c276 = "throws",
      peg$c277 = peg$literalExpectation("throws", false),
      peg$c278 = "throw",
      peg$c279 = peg$literalExpectation("throw", false),
      peg$c280 = "true",
      peg$c281 = peg$literalExpectation("true", false),
      peg$c282 = "try",
      peg$c283 = peg$literalExpectation("try", false),
      peg$c284 = "void",
      peg$c285 = peg$literalExpectation("void", false),
      peg$c286 = "while",
      peg$c287 = peg$literalExpectation("while", false),
      peg$c288 = function() { return { node: 'BooleanLiteral', booleanValue: true }; },
      peg$c289 = function() { return { node: 'BooleanLiteral', booleanValue: false }; },
      peg$c290 = function() { return { node: 'NullLiteral' }; },
      peg$c291 = function(literal) { return literal; },
      peg$c292 = /^[lL]/,
      peg$c293 = peg$classExpectation(["l", "L"], false, false),
      peg$c294 = function() { return { node: 'NumberLiteral', token: text() }; },
      peg$c295 = "0",
      peg$c296 = peg$literalExpectation("0", false),
      peg$c297 = /^[1-9]/,
      peg$c298 = peg$classExpectation([["1", "9"]], false, false),
      peg$c299 = /^[_]/,
      peg$c300 = peg$classExpectation(["_"], false, false),
      peg$c301 = "0x",
      peg$c302 = peg$literalExpectation("0x", false),
      peg$c303 = "0X",
      peg$c304 = peg$literalExpectation("0X", false),
      peg$c305 = "0b",
      peg$c306 = peg$literalExpectation("0b", false),
      peg$c307 = "0B",
      peg$c308 = peg$literalExpectation("0B", false),
      peg$c309 = /^[01]/,
      peg$c310 = peg$classExpectation(["0", "1"], false, false),
      peg$c311 = /^[0-7]/,
      peg$c312 = peg$classExpectation([["0", "7"]], false, false),
      peg$c313 = ".",
      peg$c314 = peg$literalExpectation(".", false),
      peg$c315 = /^[fFdD]/,
      peg$c316 = peg$classExpectation(["f", "F", "d", "D"], false, false),
      peg$c317 = /^[eE]/,
      peg$c318 = peg$classExpectation(["e", "E"], false, false),
      peg$c319 = /^[+\-]/,
      peg$c320 = peg$classExpectation(["+", "-"], false, false),
      peg$c321 = /^[pP]/,
      peg$c322 = peg$classExpectation(["p", "P"], false, false),
      peg$c323 = /^[a-f]/,
      peg$c324 = peg$classExpectation([["a", "f"]], false, false),
      peg$c325 = /^[A-F]/,
      peg$c326 = peg$classExpectation([["A", "F"]], false, false),
      peg$c327 = "'",
      peg$c328 = peg$literalExpectation("'", false),
      peg$c329 = /^['\\\n\r]/,
      peg$c330 = peg$classExpectation(["'", "\\", "\n", "\r"], false, false),
      peg$c331 = function() { return { node: 'CharacterLiteral', escapedValue: text() }; },
      peg$c332 = "\"",
      peg$c333 = peg$literalExpectation("\"", false),
      peg$c334 = /^["\\\n\r]/,
      peg$c335 = peg$classExpectation(["\"", "\\", "\n", "\r"], false, false),
      peg$c336 = function() { return { node: 'StringLiteral', escapedValue: text() }; },
      peg$c337 = "\\",
      peg$c338 = peg$literalExpectation("\\", false),
      peg$c339 = /^[btnfr"'\\]/,
      peg$c340 = peg$classExpectation(["b", "t", "n", "f", "r", "\"", "'", "\\"], false, false),
      peg$c341 = /^[0-3]/,
      peg$c342 = peg$classExpectation([["0", "3"]], false, false),
      peg$c343 = "u",
      ...
      if (s2 !== peg$FAILED) {
        ...
        if (s3 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            ...
            if (s5 !== peg$FAILED) {
              s6 = peg$parseEmptyLines();
              if (s6 !== peg$FAILED) {
                s7 = peg$currPos;
                s8 = peg$parseIMPLEMENTS();
                if (s8 !== peg$FAILED) {
                  s9 = peg$parseClassTypeList();
                  if (s9 !== peg$FAILED) {
                    s8 = [s8, s9];
                    s7 = s8;
                  } else {
