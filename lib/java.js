...
function peg$parse(input, options) {
  ...
  var peg$FAILED = {},
      ...
      peg$c189 = function(commentStatements) { return leadingComments(commentStatements); },
      peg$c190 = function(comment) { return comment; },
      peg$c191 = function(commentStatement) { return commentStatement; },
      peg$c192 = "/**",
      peg$c193 = peg$literalExpectation("/**", false),
      peg$c194 = "*/",
      peg$c195 = peg$literalExpectation("*/", false),
      peg$c196 = function(comment) { return { value: "/**" + comment.join("") + "*/" }; },
      peg$c197 = "/*",
      ...
      peg$c203 = function(comment) { return { value: "/*" + comment.join("") + "*/" }; },
      peg$c204 = function(letter) { return letter[1]; },
      peg$c205 = "//",
      peg$c206 = peg$literalExpectation("//", false),
      peg$c207 = function(comment) { return { value: "//" + comment.join("") }; },
      peg$c208 = function(first, rest) { return { identifier: first + rest, node: 'SimpleName' }; },
      peg$c209 = /^[a-z]/,
      peg$c210 = peg$classExpectation([["a", "z"]], false, false),
      peg$c211 = /^[A-Z]/,
      peg$c212 = peg$classExpectation([["A", "Z"]], false, false),
      peg$c213 = /^[_$]/,
      peg$c214 = peg$classExpectation(["_", "$"], false, false),
      peg$c215 = /^[0-9]/,
      peg$c216 = peg$classExpectation([["0", "9"]], false, false),
      peg$c217 = "assert",
      peg$c218 = peg$literalExpectation("assert", false),
      peg$c219 = "break",
      peg$c220 = peg$literalExpectation("break", false),
      peg$c221 = "case",
      peg$c222 = peg$literalExpectation("case", false),
      peg$c223 = "catch",
      peg$c224 = peg$literalExpectation("catch", false),
      peg$c225 = "class",
      peg$c226 = peg$literalExpectation("class", false),
      peg$c227 = "const",
      peg$c228 = peg$literalExpectation("const", false),
      peg$c229 = "continue",
      peg$c230 = peg$literalExpectation("continue", false),
      peg$c231 = "default",
      peg$c232 = peg$literalExpectation("default", false),
      peg$c233 = "do",
      peg$c234 = peg$literalExpectation("do", false),
      peg$c235 = "else",
      peg$c236 = peg$literalExpectation("else", false),
      peg$c237 = "enum",
      peg$c238 = peg$literalExpectation("enum", false),
      peg$c239 = "extends",
      peg$c240 = peg$literalExpectation("extends", false),
      peg$c241 = "false",
      peg$c242 = peg$literalExpectation("false", false),
      peg$c243 = "finally",
      peg$c244 = peg$literalExpectation("finally", false),
      peg$c245 = "for",
      peg$c246 = peg$literalExpectation("for", false),
      peg$c247 = "goto",
      peg$c248 = peg$literalExpectation("goto", false),
      peg$c249 = "if",
      peg$c250 = peg$literalExpectation("if", false),
      peg$c251 = "implements",
      peg$c252 = peg$literalExpectation("implements", false),
      peg$c253 = "import",
      peg$c254 = peg$literalExpectation("import", false),
      peg$c255 = "interface",
      peg$c256 = peg$literalExpectation("interface", false),
      peg$c257 = "instanceof",
      peg$c258 = peg$literalExpectation("instanceof", false),
      peg$c259 = "new",
      peg$c260 = peg$literalExpectation("new", false),
      peg$c261 = "null",
      peg$c262 = peg$literalExpectation("null", false),
      peg$c263 = "package",
      peg$c264 = peg$literalExpectation("package", false),
      peg$c265 = "return",
      peg$c266 = peg$literalExpectation("return", false),
      peg$c267 = "super",
      peg$c268 = peg$literalExpectation("super", false),
      peg$c269 = "switch",
      peg$c270 = peg$literalExpectation("switch", false),
      peg$c271 = "this",
      peg$c272 = peg$literalExpectation("this", false),
      peg$c273 = "throws",
      peg$c274 = peg$literalExpectation("throws", false),
      peg$c275 = "throw",
      peg$c276 = peg$literalExpectation("throw", false),
      peg$c277 = "true",
      peg$c278 = peg$literalExpectation("true", false),
      peg$c279 = "try",
      peg$c280 = peg$literalExpectation("try", false),
      peg$c281 = "void",
      peg$c282 = peg$literalExpectation("void", false),
      peg$c283 = "while",
      peg$c284 = peg$literalExpectation("while", false),
      peg$c285 = function() { return { node: 'BooleanLiteral', booleanValue: true }; },
      peg$c286 = function() { return { node: 'BooleanLiteral', booleanValue: false }; },
      peg$c287 = function() { return { node: 'NullLiteral' }; },
      peg$c288 = function(literal) { return literal; },
      peg$c289 = /^[lL]/,
      peg$c290 = peg$classExpectation(["l", "L"], false, false),
      peg$c291 = function() { return { node: 'NumberLiteral', token: text() }; },
      peg$c292 = "0",
      peg$c293 = peg$literalExpectation("0", false),
      peg$c294 = /^[1-9]/,
      peg$c295 = peg$classExpectation([["1", "9"]], false, false),
      peg$c296 = /^[_]/,
      peg$c297 = peg$classExpectation(["_"], false, false),
      peg$c298 = "0x",
      peg$c299 = peg$literalExpectation("0x", false),
      peg$c300 = "0X",
      peg$c301 = peg$literalExpectation("0X", false),
      peg$c302 = "0b",
      peg$c303 = peg$literalExpectation("0b", false),
      peg$c304 = "0B",
      peg$c305 = peg$literalExpectation("0B", false),
      peg$c306 = /^[01]/,
      peg$c307 = peg$classExpectation(["0", "1"], false, false),
      peg$c308 = /^[0-7]/,
      peg$c309 = peg$classExpectation([["0", "7"]], false, false),
      peg$c310 = ".",
      peg$c311 = peg$literalExpectation(".", false),
      peg$c312 = /^[fFdD]/,
      peg$c313 = peg$classExpectation(["f", "F", "d", "D"], false, false),
      peg$c314 = /^[eE]/,
      peg$c315 = peg$classExpectation(["e", "E"], false, false),
      peg$c316 = /^[+\-]/,
      peg$c317 = peg$classExpectation(["+", "-"], false, false),
      peg$c318 = /^[pP]/,
      peg$c319 = peg$classExpectation(["p", "P"], false, false),
      peg$c320 = /^[a-f]/,
      peg$c321 = peg$classExpectation([["a", "f"]], false, false),
      peg$c322 = /^[A-F]/,
      peg$c323 = peg$classExpectation([["A", "F"]], false, false),
      peg$c324 = "'",
      peg$c325 = peg$literalExpectation("'", false),
      peg$c326 = /^['\\\n\r]/,
      peg$c327 = peg$classExpectation(["'", "\\", "\n", "\r"], false, false),
      peg$c328 = function() { return { node: 'CharacterLiteral', escapedValue: text() }; },
      peg$c329 = "\"",
      peg$c330 = peg$literalExpectation("\"", false),
      peg$c331 = /^["\\\n\r]/,
      peg$c332 = peg$classExpectation(["\"", "\\", "\n", "\r"], false, false),
      peg$c333 = function() { return { node: 'StringLiteral', escapedValue: text() }; },
      peg$c334 = "\\",
      peg$c335 = peg$literalExpectation("\\", false),
      peg$c336 = /^[btnfr"'\\]/,
      peg$c337 = peg$classExpectation(["b", "t", "n", "f", "r", "\"", "'", "\\"], false, false),
      peg$c338 = /^[0-3]/,
      peg$c339 = peg$classExpectation([["0", "3"]], false, false),
      peg$c340 = "u",
      peg$c341 = peg$literalExpectation("u", false),
      peg$c342 = "@",
